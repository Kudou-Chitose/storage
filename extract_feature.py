...
t3['this_month_user_receive_same_coupon_lastone'] = t3.max_date_received.astype('float') - t3.date_received.astype('float')
t3['this_month_user_receive_same_coupon_firstone'] = t3.date_received.astype('float') - t3.min_date_received.astype('float')
...
dataset3['is_holiday'] = dataset3.date_received.apply(lambda x:1 if x in (20160101, 20160207, 20160208, 20160214, 20160222, 20160308, 20160404, 20160501, 20160508, 20160609, 20160619) else 0)
...
dataset2['is_holiday'] = dataset2.date_received.apply(lambda x:1 if x in (20160101, 20160207, 20160208, 20160214, 20160222, 20160308, 20160404, 20160501, 20160508, 20160609, 20160619) else 0)
...
dataset1['is_holiday'] = dataset1.date_received.apply(lambda x:1 if x in (20160101, 20160207, 20160208, 20160214, 20160222, 20160308, 20160404, 20160501, 20160508, 20160609, 20160619) else 0)
